...
Es el caso de este último sistema de control de versiones del que hablaremos en esta página web. Un poco de su historia, seguido de la nociones básicas para poder utilizarlo, como su sintaxis. Ádemas, su uso en relación a la práctica cuatro, realizada de forma grupal, de la asignatura Metodologías de Desarrollo de Software de la Universidad de Alicante. <br>
...
Comenzaremos la instalación del sistema de control de versiones descargandolo. Dependiendo del sistema operativo que usemos, lo podremos hacer mediante línea
...
hg add .
```
**Una vez añadidos los ficheros, podemos hacer el primer commit de nuestro repositorio:** <br>
...
hg commit -m "Principal" -m "Detalles"
```
...
Por ello, hg dispone al igual que git de una serie de directivas para hacernos la vida más fácil a la hora de programar. <br> 
Tanto de forma individual como en grupo. <br>
<br>
**Rama por defecto en Mercurial** <br>
Default es el nombre que tiene la rama que crea Mercurial al crear un proyecto desde cero. <br> <br>
**Cómo podemos crear nuestras propias ramas:**
```
...
Una vez revisado este commit, tenemos tres opciones: que sea justamente el commit del error, que sea un commit "bueno" o que siga existiendo el error pero no causado por el commit. Seguiremos usando bisect de la misma manera hasta dar con el fallo dentro del código. <br>
Parece una herramienta de lo más trivial, pero cuando existen miles de commits dentro de un poryecto se vuelve una herramienta muy útil.
...
Las extensiones se deben **habilitar**, por ejemplo en ```.hg/hgrc```:
```
[extensions] 
foo =
# Podemos especificar la ruta concreta deonde se encuenta la extensión
[extensions] 
...
baz = ! 
```
**Tenemos disponibles cantidad de extensiones desarrolladas por terceros que podemos incluir en nuestro proyecto Mercurial** <br>
En este [enlace](https://www.mercurial-scm.org/wiki/UsingExtensions#Extensions_provided_by_others) tenemos una lista de algunas de ellas. <br>
Reconocidas oficialmente por Mercurial. <br>

**Para dar de alta un nuevo repositorio en un proyecto, edita ```\<proyecto>/.hg/hgrc``` y añade una nueva entrada en
paths así:**
```
[paths]
...
**Hacer efectivos los cambios locales de nuestro repositorio de forma remota:** <br>
Hasta ahora hemos estado trabajando de forma local. Siendo nosotros solos los desarrolladores del poryecto y guardando todo nuestro proyecto en nuestra máquina. <br>
...
Más tarde veremos una plataforma similar a GitHub para tener nuestro repositorio remoto. Y como configurarlo todo. <br>

**Descargar los cambios remotos a nuestro poryecto local:** <br>
...
Una vez hemos creado nuestra cuenta, volvemos [aquí](https://heptapod.host/users/sign_in) y nos conectamos usando nuestra cuenta de GitHub. Marcaremos las dos casillas que aparecen. <br>
...
de la práctica cuatro salvando las distancias. <br>
...
una plantilla con ficheros iniciales ya creados, ideal para guardar una estructura dada por un lenguaje de programación en concreto. La última y la que nos interesa en este caso es poder importar tus repositorios directamente de GitHub o algunos de los sistemas de control de versiones más importantes.  <br>
...
Se nos listarán todos los repositorios disponibles, en nuestro caso escogemos el repositorio "mads-ua-20-21/todolist-final-equipo-08" y le damos a importar.
